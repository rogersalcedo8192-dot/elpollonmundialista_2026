...
- 2026-06-15: actualizados los encabezados de columnas del PolloRanking en mobile y escritorio para usar la nomenclatura PTS: Total PTS, PTS X participar, PTS X marcador exacto (L o V) y PTS X marcador exacto empate; el estado estable ahora se muestra como Sin cambio o Se mantuvo igual segun el espacio disponible.
