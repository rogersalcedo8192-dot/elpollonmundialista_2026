...
- 2026-06-23: ajustada la vista publica "Llaves" para que la fase de grupos use un color simetrico unico en ambos lados del diagrama; las banderas muestran su etiqueta compacta solo al hacer clic, los encabezados quedan como Grupo A-L, el campeon pendiente se muestra como POR DEFINIR, la capsula Gran final usa dorado y el scroll/zoom mobile se ajusta al ancho real de la llave, sin cambios de datos ni escrituras.
...
- 2026-06-12: Pronosticos Publicos ahora habilita cada partido al alcanzar su hora oficial de inicio, incluso si el proveedor externo tarda en cambiarlo de pendiente a en curso; el ajuste es solo de lectura y no modifica partidos ni pronosticos.
